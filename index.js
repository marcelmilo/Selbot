...
const fs = require('fs');
//const fs = require('fs');
const ownerId = 'YOUR OWNER ID HERE'; // apna developer id daal lena 
...
client.on('ready', async () => {
  ...
  const r = new Discord.RichPresence()
    .setApplicationId('1157278323391594528')
    .setType('WATCHING') 
    .setURL('https://discord.gg/crustycrab')
    .setState('Nitro | Exchanges | 24/7 Support')

    .setName('10% fastest Exchanger')
    .setDetails('2€ Cheapest Nitro')


    .setStartTimestamp(Date.now())
    .setAssetsLargeImage('https://media.discordapp.net/attachments/1157460147057201234/1157692327272382615/Logo.png?ex=6519887f&is=651836ff&hm=1ce88379d26624fcc009e6eb45d59a4c00997c5a4344692b824b5b495c8bc3c9&=')
    .setAssetsLargeText('')
    
    .setAssetsSmallText('<- Buy Now')
        .addButton('Tools Shop', "https://planktonstools.mysellix.io")
    .addButton('Discord Server ',"https://discord.gg/crustycrab")
